...
var app_rooting_module_1 = require("./app-rooting.module");
var pokemons_module_1 = require("./pokemons/pokemons.module");
var app_component_1 = require("./app.component");
var page_not_found_component_1 = require("./page-not-found.component");
var forms_1 = require("@angular/forms");
var login_component_1 = require("./login.component");
var longin_routing_module_1 = require("./longin-routing.module");
    ...
    AppModule = __decorate([
        core_1.NgModule({
            imports: [platform_browser_1.BrowserModule,
                ...
                longin_routing_module_1.LoginRoutingModule,
                app_rooting_module_1.AppRoutingModule],
